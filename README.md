...
<img src="assets/agent-tracer-hero.png" alt="agent-tracer — Vedic Arsenal by Darshankumar Joshi" width="100%" />

# 🔮 agent-tracer

<h3><em>अनुसरण</em></h3>

> *Anusarana — following the cosmic trace*
...
```mermaid
flowchart LR
    A[Input] --> B[agent-tracer]
    B --> C{Process}
    C -- Success --> D[Output]
    C -- Error --> E[Handle / Retry]
    E --> B
    style B fill:#6b21a8,color:#fff
    note["Tracer — Zero Dependencies"]
```
